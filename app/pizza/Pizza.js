'use strict';
angular.module('pizza', ['ngRoute', 'ngResource', 'pizza.ingredient'])
    ...
    .service('Pizza',['$rootScope', function ($rootScope) {
        var self = {};
        ...
        self.add = function (ingredient) {
            ...
            if (!self.validIngredient(ingredient))
                return;
        ...
        self.validIngredient = function (ingredient) {
            switch (ingredient.type) {
                ...
                case "topping":
                    ...
                    else if (self.pizzaIngredient.filter(function (value) {
                            return value.ingredient.type === 'base'
                        })[0].ingredient.portions < self.pizzaIngredient.filter(function (value) {
                            return value.ingredient.type === 'topping'
                        }).sum("count") + 1) {
                        setError("You can't add more than " + self.pizzaIngredient.filter(function (value) {
                                return value.ingredient.type === 'base'
                            })[0].ingredient.portions + " portions of topping to this base");
                        return false;
                    }
                    break;
            }
        ...
        self.hasBase = function () {
            return self.pizzaIngredient.filter(function (value) {
                    return value.ingredient.type === 'base'
                }).length > 0;
        };
